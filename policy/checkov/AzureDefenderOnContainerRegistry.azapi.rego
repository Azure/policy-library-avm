...
valid_azapi_security_center_subscription_container_registry_pricing_is_standard(resource) if {
...
deny_CKV_AZURE_86 contains reason if {
    ...
    not valid_azapi_security_center_subscription_container_registry_pricing_is_standard(resource)
