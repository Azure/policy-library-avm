...
deny_enable_zone_redundancy_for_api_management contains reason if {
    ...
    reason := sprintf("Azure-Proactive-Resiliency-Library-v2/enable_zone_redundancy_for_api_management: '%s' `azapi_resource` must be configured to use at least 2 Availability Zones: https://azure.github.io/Azure-Proactive-Resiliency-Library-v2/azure-resources/ApiManagement/service/#enable-availability-zones-on-premium-api-management-instances", [resource.address])
}